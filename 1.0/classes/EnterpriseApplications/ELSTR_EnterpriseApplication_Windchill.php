<?php
    ...
    require_once('Services/ELSTR_Service_Windchill_REST.php');
     ...
     * @author Marco Egli
     */
    class ELSTR_EnterpriseApplication_Windchill extends ELSTR_EnterpriseApplication_Acl_Abstract
    {
        ...
        protected function _initServices() {
        	$this->registerService(new ELSTR_Service_Windchill_REST($this->m_options));
        }
